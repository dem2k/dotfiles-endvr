...
;;; Variables
;; (setq debug-on-message ".*separator will match.*")
...
;; takes care to avoid the initial flash of light. this dont work?
...
;; If the source file is newer than the compiled file,
;; load it instead of the compiled version.
(setq load-prefer-newer t)

;; Set-language-environment sets default-input-method, which is unwanted.
;; (setq default-input-method nil)  ;; RFC1345 ?
...
(unless (daemonp)
  (unless noninteractive
    (when (fboundp 'tool-bar-setup)
      ...
      ;; from during the initial stages of startup
...
(setq package-archives '(("melpa-dev" . "https://melpa.org/packages/")
                         ("melpa-stable" . "https://stable.melpa.org/packages/")
                         ("gnu" . "https://elpa.gnu.org/packages/")
                         ("nongnu" . "https://elpa.nongnu.org/nongnu/")))
(customize-set-variable 'package-archive-priorities '(("melpa-dev"  . 90)
                                                      ("melpa-stable" . 80)
                                                      ("gnu"    . 70)
                                                      ("nongnu" . 50)))
